...
void FrustumCulling::Plane::Normalize()
...
bool FrustumCulling::IsBoxInFrustum(glm::mat4 _projectionMatrix, glm::mat4 _viewMatrix, glm::vec3 _minCorner, glm::vec3 _maxCorner)
{
