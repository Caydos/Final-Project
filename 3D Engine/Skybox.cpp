...
void Skybox::Load(GameData* _gameData)
{
    ...
    {
        ("../Textures/Skybox/Front.jpg"), // Right
        ("../Textures/Skybox/Back.jpg"), //Left
        ("../Textures/Skybox/Top.jpg"), //top
        ("../Textures/Skybox/Bottom.jpg"), //bottom
        ("../Textures/Skybox/Right.jpg"), //front 
        ("../Textures/Skybox/Left.jpg"), //back
    };
